...
class RCS():
    ...
    # TODO - deprecate - this will be done elsewhere in all future versions????
    ...
    # TODO - move spline and yellow line fitting to a separate object and subclass it in this one so we can initialize it seaprately? IDK but organize these functions separately    
    ...
    # TODO - move to rcs_util.py - but for purposes of i24_code perhaps deprecate
    ...
    # TODO move to util / deprecate for i24 system
